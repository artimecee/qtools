...
//*
//* masslen - the number of bytes received in a single block without analyzing the 7F terminator
//******************************************************************************************
...
//Instead of the full device name, only the ttyUSB port number is allowed to be transmitted
